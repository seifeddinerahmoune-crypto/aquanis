...
try:
    ...
    if prompt:
        ...
        system_prompt = (
            ...
            "NEVER wrap equations in square brackets [ ] or parentheses ( ) as a substitute for LaTeX delimiters "
            "(for example, never write '([ H = z_2 - z_1 ])' or '[ x^2 ]'). "
            "The ONLY valid delimiters are single $ for inline math and double $$ for block/standalone equations. "
